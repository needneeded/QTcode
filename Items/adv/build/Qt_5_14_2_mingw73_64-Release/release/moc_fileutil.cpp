...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_FileUtil_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_FileUtil_t qt_meta_stringdata_FileUtil = {
    {
QT_MOC_LITERAL(0, 0, 8) // "FileUtil"
...
QT_INIT_METAOBJECT const QMetaObject FileUtil::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_FileUtil.data,
    qt_meta_data_FileUtil,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *FileUtil::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_FileUtil.stringdata0))
